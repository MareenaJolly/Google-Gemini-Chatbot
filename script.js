...
//API configuration
const API_KEY = "AIzaSyAod9SXKbxzIbbRvKoz2eVorRfYESN8qH0";
...
// Show a loading animation while waiing for the API response
...
const handleOutgoingChat = ()=> {
    ...
    if(!userMessage || isResponseGenerating) return; //Exit if there is no messgae
